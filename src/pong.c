...
int main(void) {
    ...
    while (score_racket_left != 21 || score_racket_right != 21) {
        ...
        if (x_ball == 1) {
            if ((y_ball == y_racket_left) ||
                (y_ball == y_racket_left - 1) || (y_ball == y_racket_left + 1)) {
                if (last_key_left == 'a') {
                    BallPhase = -2;
                } else {
                    BallPhase = 2;
        ...
        if (x_ball == 78) {
            if ((y_ball == y_racket_rigth) ||
                (y_ball == y_racket_rigth - 1) || (y_ball == y_racket_rigth + 1)) {
                if (last_key_left == 'k') {
                    BallPhase = -1;
                } else {
                    BallPhase = 1;
